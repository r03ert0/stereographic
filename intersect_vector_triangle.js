/**
 * @desc Adapted from intersect_RayTriangle()
 ...
 * @returnValue {c0, c1, case} object The triangle-based coordinates of the intersection (when it exists)
...
function intersectVectorTriangle(x, T) {
    let c0, c1;
    let xx = [];
    let u = [], v = [], n = []; // triangle vectors
    let dir = [], w0 = [], w = []; // ray vectors
